...
.PHONY: network postgres createdb dropdb migrateup migratedown sqlc test server mock startpg stoppg migrateup1 migratedown1 buildimage runcontainer dbdocs dbschema proto evans redis