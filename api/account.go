...
// getAccount gets an account stored in the DB by ID
func (server *Server) getAccount(ctx *gin.Context) {
	...
	if account.Owner != authPayload.Username {
		err := errors.New("user-account mismatch")
...
// listAccounts gets a paginated list of accounts
